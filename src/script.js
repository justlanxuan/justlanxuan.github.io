...
function getColor(drink) {
  ...
  if (drink.type === "coffee") {
    baseColor = `rgba(139, 69, 19, 1)`;
  } else if (drink.type === "energyDrinks") {
    baseColor = `rgba(255, 165, 0, 1)`;
  } else if (drink.type === "softDrinks") {
    baseColor = `rgba(0, 191, 255, 1)`;
  }
...
//这是图二的数据，编的，需要改
const sleepData = [
  { sleepScore: 3, effectiveSleep: 3, totalSleep: 8, movement: 1 },
  { sleepScore: 4, effectiveSleep: 4, totalSleep: 8, movement: 2 },
  { sleepScore: 5, effectiveSleep: 5, totalSleep: 8, movement: 3 },
  { sleepScore: 6, effectiveSleep: 5, totalSleep: 8, movement: 4 },
  { sleepScore: 7, effectiveSleep: 6, totalSleep: 8, movement: 5 },
  { sleepScore: 8, effectiveSleep: 6, totalSleep: 8, movement: 6 },
  { sleepScore: 9, effectiveSleep: 7, totalSleep: 8, movement: 7 },
  { sleepScore: 10, effectiveSleep: 8, totalSleep: 8, movement: 8 },
];
  ...
  const data = {
    datasets: [
      ...
      },
      {
        ...
        backgroundColor: ["rgba(188, 165, 153, 1)", "rgba(255, 255, 255, 1)"],
      },
      {
        data: [
        ...
        backgroundColor: ["rgba(135, 72, 40, 1)", "rgba(255, 255, 255, 1)"],
      },
      {
        data: 0,
